...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public Employer getByUsername1(String username){
        // 构造查询条件
    ...
    @Override
    public Employee save(Employee employee, String upload) {
        // 设置简历名称
        employee.setFilename(upload);
        // 更新
        employeeMapper.updateByPrimaryKeySelective(employee);

//        System.out.println(employee.getFilename());
        // 重新查询雇员信息
