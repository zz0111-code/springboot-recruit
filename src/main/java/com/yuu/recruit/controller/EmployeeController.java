...
public class EmployeeController {
    ...
    public String saveBase(Employee employee, HttpSession session,String upload) {
        // 更新个人信息到数据库
        Employee currEmployee = employeeService.save(employee,upload);

        // 更新 session 中的个人信息
        session.setAttribute("employee", currEmployee);
//        System.out.println(session.getAttribute(employee.getFilename()));
