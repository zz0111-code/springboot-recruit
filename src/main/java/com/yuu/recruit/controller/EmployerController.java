...
public class EmployerController {
    ...
    public String myTask(HttpSession session, Model model) {
        ...
        for (int i = 0; i < taskVos.size(); i++) {
            if (taskVos.get(i).getEmployee() != null) {
//                System.out.println(taskVos.get(i).getEmployee().getUsername());
                session.setAttribute("employeeName",taskVos.get(i).getEmployee().getUsername());
            }
        }
