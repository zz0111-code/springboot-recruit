...
@Controller
@Component
public class UserMessageController1 {
     ...
     */
    private static Map<String, UserMessageController1> clients = new ConcurrentHashMap<String, UserMessageController1>();
    ...
    public void setOgLocationService(UserMessageService userMessageService) {
        UserMessageController1.userMessageService = userMessageService;
    }
    ...
    public void onClose() {
        ...
        try {
            ...
            //所有在线用户
            map1.put("onlineUser", clients.keySet());
            //下线用户的用户名
            map1.put("username", username);
            //返回在线人数
            map1.put("number", onlineNumber);
...
//                userMessageService.save(MessageList,userMessage);
//            }
        } catch (IOException e) {
    ...
    public void onMessage(String message, Session session) {
        try {
            ...
            userMessageService.save(message1);
...
//            System.out.println(e);
    ...
    public void sendMessageTo(String message, String toUserName) throws IOException {
        //遍历所有用户
        for (UserMessageController1 item : clients.values()) {
